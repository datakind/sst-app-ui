...
export default function Banner() {
    ...
    return (<div>
      {show && message ? (<div className={classNames({
          ...
          <div className="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between flex-wrap">
              <div className="w-0 flex-1 flex items-center min-w-0">
                <span className={classNames('flex p-2 rounded-lg', {
                ...
                switch (style) {
                    case 'success':
                        return (<svg className="h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="flex-shrink-0 sm:ml-3">
                <button type="button" className={classNames('-mr-1 flex p-2 rounded-md focus:outline-none sm:-mr-2 transition', {
                'hover:bg-indigo-600 focus:bg-indigo-600': style == 'success',
                'hover:bg-red-600 focus:bg-red-600': style == 'danger',
            })} aria-label="Dismiss" onClick={e => {
                e.preventDefault();
                setShow(false);
            }}>
